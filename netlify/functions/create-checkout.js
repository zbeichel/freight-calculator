...
exports.handler = async function(event){
  ...
  // Swap this to 'https://quickfreightcalc.com' before going live
  const siteUrl = process.env.URL || process.env.DEPLOY_URL || 'https://dev--quickfreightcalculator.netlify.app';
